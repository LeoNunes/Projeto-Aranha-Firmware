...
void loop() {
  ...
  for (int posDegrees = 0; posDegrees <= 180; posDegrees++) {
    ...
    // Move Motor 2 from 0 to 100 degrees
  for (int posDegrees = 5; posDegrees <= 100; posDegrees++) {
  ...
  // Move Motor 2 from 100 to 0 degrees
  for (int posDegrees = 100; posDegrees >= 5; posDegrees--) {
